  ...
  const formatBlog = useCallback(
    (blog) => {
      return {
        ...
        categoryClass:
          blog.categoryClass ||
          getCategoryClass(blog.category),
  ...
  const handleEditSave = async (e) => {
    ...
    try {
      ...
      const updateData = {
        ...
        publishDate:
          editModalData.publishDate || null,
