...
const INITIAL_CART = [
  {
    ...
    quantity: 1,
    image:
      "https://images.unsplash.com/photo-1548907040-4baa42d10919?w=150&auto=format&fit=crop&q=80",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    quantity: 1,
    image:
      "https://images.unsplash.com/photo-1549007994-cb92caebd54b?w=150&auto=format&fit=crop&q=80",
  },
  {
    id: 4,
      ...
      >
        ...
        <div className="cart-sidebar-header">
          <div className="cart-sidebar-title-group">
            <ShoppingCart
              className="cart-sidebar-header-icon"
              size={22}
            />
            <div>
        ...
        <div className="cart-sidebar-items">
          {cartItems.length === 0 ? (
            <div className="cart-empty">
              ...
              <p>Add some delicious products to continue.</p>
            </div>
          ) : (
            cartItems.map((item) => (
                ...
                <div className="cart-sidebar-item-info">
                  ...
                  <div className="cart-sidebar-item-actions">
                    <div className="cart-sidebar-price-group">
                      <span className="cart-sidebar-price-current">
                        ₹{item.price}
                      </span>
                      <span className="cart-sidebar-price-old">
                        ₹{item.originalPrice}
                      </span>
                    </div>
                    ...
                    <div className="cart-sidebar-qty">
                      ...
                      <span className="cart-sidebar-qty-count">
                        {item.quantity}
                      </span>
        ...
        {cartItems.length > 0 && (
          <div className="cart-sidebar-footer">
            <div className="cart-sidebar-coupon">
              <Tag
                className="cart-sidebar-coupon-icon"
                size={15}
              />
              <input
                type="text"
              ...
              <button
                type="button"
                className="cart-sidebar-coupon-btn"
            ...
            <div className="cart-sidebar-bill">
              ...
              <div className="cart-sidebar-bill-row total-row">
                ...
                <span className="cart-sidebar-grand-total">
            ...
            <div className="cart-sidebar-badges">
              <div className="cart-sidebar-badge">
                <ShieldCheck
                  className="cart-sidebar-badge-icon"
                  size={16}
                />
                <span className="cart-sidebar-badge-label">
                  Secure Payment
                </span>
                <span className="cart-sidebar-badge-sublabel">
                  100% Safe
                </span>
              </div>
